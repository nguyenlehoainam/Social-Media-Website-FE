...
_(Thay thế các đường dẫn bên dưới bằng ảnh chụp màn hình thực tế của dự án)_

|                   Trang chủ (Newsfeed)                    |                         Tạo bài viết (Modal)                          |
| :-------------------------------------------------------: | :-------------------------------------------------------------------: |
| ![Home](./Social-Media-Website-FE/public/assets/demo.png) | ![Create Post](/Social-Media-Website-FE/public/assets/CreatePost.png) |

|                     Trang cá nhân (Profile)                     |                        Chi tiết bài viết                        |
| :-------------------------------------------------------------: | :-------------------------------------------------------------: |
| ![Profile](./Social-Media-Website-FE/public/assets/profile.png) | ![Details](./Social-Media-Website-FE/public/assets/details.png) |

|                         Trang Admin                         |
| :---------------------------------------------------------: |
| ![Admin](./Social-Media-Website-FE/public/assets/admin.png) |
...
3.  Cài đặt dependencies và chạy dự án:
    ...
    mvn spring-boot:run
    ```
    _Server sẽ khởi động tại: `http://localhost:8080`_
